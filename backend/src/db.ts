    ...
    createInitialData = async () => {
        ...
        await db.exec(`
          ...
          VALUES
            ...
            ('God of War', 'Action-Adventure rund um Kratos und seinen Sohn Atreus.', 'adventure', 'adventure,mythology,story,action', 'PS4,PS5', 'Santa Monica Studio', 'Sony', '2018-04-20', '', 9.6),
            ('Assassin''s Creed Valhalla', 'Open-World-Actionspiel in der Wikingerzeit.', 'rpg', 'rpg,open-world,story', 'PC,PS5,Xbox', 'Ubisoft Montreal', 'Ubisoft', '2020-11-10', '', 8.5),
            ('Hollow Knight', 'Metroidvania-Spiel in einer düsteren Welt voller Insekten.', 'metroidvania', 'metroidvania,indie,platformer,adventure', 'PC,Switch,PS', 'Team Cherry', 'Team Cherry', '2017-02-24', '', 9.3),
            ('Celeste', 'Plattformspiel über eine schwierige Bergbesteigung.', 'platformer', 'platformer,indie,story', 'PC,Switch,PS,Xbox', 'Matt Makes Games', 'Matt Makes Games', '2018-01-25', '', 9.0),
            ('The Legend of Zelda: Breath of the Wild', 'Open-World-Abenteuer in Hyrule.', 'adventure', 'adventure,open-world,exploration,fantasy', 'Switch', 'Nintendo EPD', 'Nintendo', '2017-03-03', '', 9.8),
            ...
            ('Doom Eternal', 'Fast-paced First-Person-Shooter gegen Dämonen.', 'fps', 'fps,action,shooter,demons', 'PC,PS5,Xbox', 'id Software', 'Bethesda', '2020-03-20', '', 9.1),
            ('Resident Evil Village', 'Survival-Horror in einem mysteriösen Dorf.', 'horror', 'horror,survival,story', 'PC,PS5,Xbox', 'Capcom', 'Capcom', '2021-05-07', '', 8.9),
            ('Fortnite', 'Battle Royale Shooter mit Bauelementen.', 'shooter', 'shooter,battle-royale,multiplayer', 'PC,PS5,Xbox,Mobile', 'Epic Games', 'Epic Games', '2017-07-21', '', 8.0),
            ('League of Legends', 'MOBA-Spiel mit strategischen Kämpfen.', 'moba', 'moba,strategy,multiplayer,competitive', 'PC', 'Riot Games', 'Riot Games', '2009-10-27', '', 9.0),
            ...
            ('Monster Hunter: World', 'Action-RPG mit großen Monstern und Teamplay.', 'rpg', 'rpg,action,coop', 'PC,PS4,Xbox', 'Capcom', 'Capcom', '2018-01-26', '', 9.1),
            ('Destiny','First-Person-Shooter mit MMO-Elementen, epischen Raids und kooperativen Missionen in einer futuristischen Welt.','mmo','mmo,shooter,coop,space,action','PC,PS5,Xbox','Bungie','Bungie','2014-09-09','',9.1),
            ('Teamfight Tactics','Autobattler-Spiel im League of Legends-Universum, strategisches Platzieren von Champions und Items.','strategy','strategy,autobattler,tactics,turn-based','PC','Riot Games','Riot Games','2019-06-26','',8.5),
            ('Overwatch','Team-basierter Multiplayer-Shooter mit einzigartigen Heldenfähigkeiten und schneller Action.','fps','fps,shooter,multiplayer,team-based,competitive','PC,PS5,Xbox,Switch','Blizzard Entertainment','Blizzard Entertainment','2016-05-24','',9.0),
            ('Starcraft 2','Strategie-Echtzeitspiel mit drei einzigartigen Rassen, epischer Kampagne und kompetitivem Multiplayer.','rts','rts,strategy,real-time,space,competitive,story','PC','Blizzard Entertainment','Blizzard Entertainment','2010-07-27','',9.3),
            ...
            ('Paladins','Hero-Shooter mit verschiedenen Klassen, kooperativen Missionen und kompetitivem Spielmodus.','fps','fps,shooter,hero,team-based,action','PC,PS5,Xbox,Switch','Hi-Rez Studios','Hi-Rez Studios','2016-09-16','',8.4),
            ('Factorio','Industrielles Aufbauspiel, Fabriken bauen, Ressourcen automatisieren und Produktionsketten optimieren.','simulation','simulation,strategy,management','PC','Wube Software','Wube Software','2020-08-14','',9.0),
            ('RimWorld','Kolonie-Simulation auf einem fremden Planeten, Überleben, Charaktermanagement und Storytelling.','simulation','simulation.management,indie,survival','PC','Ludeon Studios','Ludeon Studios','2018-10-17','',9.1),
            ('Rainbow Six Siege','Taktischer Multiplayer-Shooter, Zerstörung der Umgebung und Teamplay im Fokus.','fps','fps,shooter,tactical,multiplayer,competitive,team','PC,PS5,Xbox','Ubisoft','Ubisoft','2015-12-01','',9.0),
            ('World of Warships','Online-PvP-Seeschlachten, Schiffsklassen, Strategie und taktisches Gameplay.','naval combat','naval-combat,strategy,multiplayer','PC','Wargaming','Wargaming','2015-09-17','',8.6),
            ('For Honor','Nahkampf-Actionspiel mit mittelalterlichen Kriegern, Multiplayer- und Einzelspieler-Modi.','action','action,medieval,multiplayer','PC,PS5,Xbox','Ubisoft','Ubisoft','2017-02-14','',8.7),
            ('Far Cry 2','Open-World-Actionspiel in Afrika, realistische Schadensmechanik und dynamische Story.','adventure','adventure,shooter,open-world,action,story','PC,PS4,Xbox','Ubisoft','Ubisoft','2008-10-21','',8.3),
            ('Far Cry 3','Open-World-Actionspiel mit Inselsetting, Crafting, Story-Entscheidungen und Stealth-Elementen.','adventure','adventure,shooter,open-world,action,story','PC,PS4,Xbox','Ubisoft','Ubisoft','2012-11-29','',9.0),
            ('Far Cry 4','Open-World-Actionspiel in den Himalaya-Bergen, Erkundung, Quests und Waffenvielfalt.','adventure','adventure,shooter,open-world,action,exploration,story','PC,PS4,Xbox','Ubisoft','Ubisoft','2014-11-18','',8.9),
            ('Far Cry 5','Open-World-Shooter in Montana, USA, Storymissionen, Multiplayer und Koop-Modus.','adventure','adventure,shooter,open-world,action,story','PC,PS4,Xbox','Ubisoft','Ubisoft','2018-03-27','',8.8),
            ('Far Cry 6','Open-World-Actionspiel in fiktivem tropischen Setting, Story, Missionen und Fahrzeuge.','adventure','adventure,shooter,open-world,action,story','PC,PS5,Xbox','Ubisoft','Ubisoft','2021-10-07','',8.7),
            ('Battlefield 3','First-Person-Shooter mit großen Multiplayer-Schlachten, Fahrzeugen und realistischem Gameplay.','fps','fps,shooter,multiplayer,action','PC,PS4,Xbox','DICE','Electronic Arts','2011-10-25','',9.0),
            ('Battlefield 4','Multiplayer-Shooter mit dynamischen Karten, Teamplay und realistischem Schadensmodell.','fps','fps,shooter,multiplayer,action,team','PC,PS4,Xbox','DICE','Electronic Arts','2013-10-29','',8.8),
            ('Call of Duty: Modern Warfare','Moderne Militär-Shooter-Serie mit Einzelspieler-Kampagne und Multiplayer-Modi.','fps','fps,shooter,action,competitive','PC,PS4,Xbox','Infinity Ward','Activision','2019-10-25','',9.2),
            ('Horizon Zero Dawn','Open-World-Action-RPG mit Roboterdinosauriern, Crafting und Story-Entscheidungen.','adventure','adventure,action,rpg,open-world,story','PC,PS4','Guerrilla Games','Sony','2017-02-28','',9.1),
            ('Horizon Forbidden West','Fortsetzung von Horizon Zero Dawn, neue Welt, Story, Kampf gegen Maschinen und Erkundung.','adventure','adventure,action,rpg,open-world,story,adventure','PC,PS5','Guerrilla Games','Sony','2022-02-18','',9.3),
            ('Clair Obscur: Expedition 33', 'Clair Obscur: Expedition 33 ist ein preisgekröntes, von der Kritik gefeiertes Rollenspiel aus dem Jahr 2025, entwickelt von dem französischen Studio Sandfall Interactive und veröffentlicht von Kepler Interactive. Das Spiel kombiniert eine tiefgründige narrative Struktur mit taktischen rundenbasierten Kämpfen, kunstvoller Belle‑Époque‑inspirierten Weltgestaltung und emotional aufgeladenen Charakterbögen. Spieler begleiten eine Expedition gegen eine mysteriöse, übernatürliche Bedrohung in einer eindrucksvoll gestalteten Fantasy‑Welt, in der Licht‑ und Schattenmotivik als zentrales künstlerisches Thema dient. Clair Obscur erhielt zahlreiche Auszeichnungen, darunter Game of the Year 2025 bei den The Game Awards, Best Narrative, Best Art Direction und Best Score und wurde von Kritikern und Spielern für seine Story, Musik und visuelle Gestaltung gelobt. Das Spiel wurde am 24. April 2025 für PlayStation 5, Windows und Xbox Series X/S veröffentlicht und verkaufte bis Ende 2025 über fünf Millionen Einheiten.', 'adventure', 'adventure,rpg,story,turn-based,fantasy', 'PC,PS5,Xbox', 'Sandfall Interactive', 'Kepler Interactive', '2025-04-24', '', 9.8);
